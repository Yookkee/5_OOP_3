...
namespace japroc_company.oop3
{
    ...
    //     - An empty oop3 file in the same directory as NewFileItems.vsdir. In
    //       our case we chose oop3ExtFile.oop3. Note this file name appears in Editor.vsdir
    ...
    //          - "oop3ExtFile" - This is the base file name. New files will initially
    //             be named as oop3ExtFile1.oop3, oop3ExtFile2.oop3... etc.
    ///////////////////////////////////////////////////////////////////////////////
    // Editor.vsdir contents:-
    //    oop3ExtFile.oop3|{3085E1D6-A938-478e-BE49-3546C09A1AB1}|#106|80|#109|0|401|0|#107
    //
    // The fields in order are as follows:-
    //    - oop3ExtFile.oop3 - our empty oop3 file
                                ...
                                IVsToolboxUser      //Sends notification about Toolbox items to the owner of these items
    {
        ...
        private const string MyExtension = ".oop3";
        ...
        public EditorPane(oop3Package package)
            : base(null)
        {
            PrivateInit(package);
        }
        ...
        /// <summary>
        /// Initialization routine for the Editor. Loads the list of properties for the oop3 document 
        /// which will show up in the properties window 
        /// </summary>
        /// <param name="package"></param>
        private void PrivateInit(oop3Package package)
        {
            myPackage = package;
            loading = false;
        ...
        private void setupCommands()
        {
            ...
            if (null != mcs)
            {
                ...
                addCommand(mcs, GuidList.guidoop3CmdSet, (int)PkgCmdIDList.icmdStrike,
        ...
        private void DisplayContextMenuAt(Point point)
        {
            ...
            CommandID contextMenuID = new CommandID(GuidList.guidoop3CmdSet, PkgCmdIDList.IDMX_RTF);
        ...
        {
            pClassID = GuidList.guidoop3EditorFactory;
            return VSConstants.S_OK;
        }
