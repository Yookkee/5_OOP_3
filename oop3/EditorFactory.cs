...
namespace japroc_company.oop3
{
    ...
    /// </summary>
    [Guid(GuidList.guidoop3EditorFactoryString)]
    public sealed class EditorFactory : IVsEditorFactory, IDisposable
    {
        private oop3Package editorPackage;
        private ServiceProvider vsServiceProvider;


        public EditorFactory(oop3Package package)
        {
                        ...
                        out int pgrfCDW)
        {
            ...
            pguidCmdUI = GuidList.guidoop3EditorFactory;
            pgrfCDW = 0;
