...
namespace oop3_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void InitializeMenuCommand()
        {
            ...
            CommandID menuCommandID = new CommandID(japroc_company.oop3.GuidList.guidoop3CmdSet, (int)japroc_company.oop3.PkgCmdIDList.japroccompanyid);
