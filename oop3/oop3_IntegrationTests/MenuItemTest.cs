...
namespace oop3_IntegrationTests
{
    ...
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(japroc_company.oop3.GuidList.guidoop3CmdSet, (int)japroc_company.oop3.PkgCmdIDList.japroccompanyid);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "oop3", "japroc_company.oop3.oop3Package");
